...
class genericKeyboard(threading.Thread):
    ...
    def interrupt(self):
        ...
        if A == 0:
            ...
            self.register[2] = self.state[self.register[1] & 0xFF]
        elif A == 3:
...
genericKeyboard.translate[K_RSHIFT] = 0x90
genericKeyboard.translate[K_LSHIFT] = 0x90
genericKeyboard.translate[K_RCTRL] = 0x91
genericKeyboard.translate[K_LCTRL] = 0x91
